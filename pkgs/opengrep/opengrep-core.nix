{
  ...
  binaries = {
    aarch64-linux = fetchurl {
      url = "https://github.com/spotdemo4/opengrep/releases/download/v1.6.0/opengrep-core_linux_aarch64.tar.gz";
      hash = "sha256:80d2d31fc894b45aba907b172ac4267ae4e5ee0a994eeda5048e29d8a999fcfa";
    };
    x86_64-linux = fetchurl {
      url = "https://github.com/spotdemo4/opengrep/releases/download/v1.6.0/opengrep-core_linux_x86.tar.gz";
      hash = "sha256:b414306b6b88100f71bb4929f83a24f2da9db6270baf0b910420e1aaf73a7132";
    };
    aarch64-darwin = fetchurl {
      url = "https://github.com/spotdemo4/opengrep/releases/download/v1.6.0/opengrep-core_osx_aarch64.tar.gz";
      hash = "sha256:a64c8da6b0ad0de64e4875abbafb893425f109023de38257de099889fca395d9";
    };
    x86_64-darwin = fetchurl {
      url = "https://github.com/spotdemo4/opengrep/releases/download/v1.6.0/opengrep-core_osx_x86.tar.gz";
